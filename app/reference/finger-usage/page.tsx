...
Использование клавиш глобально не является равномерным. Хорошая раскладка использует эти данные чтобы вывести лучший способ набора текста. Ниже представлена тепловая карта использования клавиатуры в целом, собранная среди раскладок [ЙЦУКЕН](/layouts/1), [QWERTY](/layouts/10) и [Colemak](/layouts/12). На графике вместо символов отображены коды используемых клавиш раскладки [ANSI](/keyboards/1).
`;
